...
<section>
  <div class="container">
    ...
    <p><strong>Data protection questions.</strong> Send them to <a href="mailto:info@dysnet.org?subject=Data%20protection">info@dysnet.org</a> with <em>data protection</em> in the subject line, and the board answers them. DysNet has not appointed a data protection officer in the sense of Article 37 GDPR, and that article does not require one of an association running a website of this kind. A data protection officer will be named before the registry begins processing health data, and this page will say who.</p>
