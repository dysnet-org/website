...
BOARD = [
    ...
    ("Dr Loïc Rigal", "Deputy chair · France", "Doctor in pharmaceutical law and patient advocate. Elected board member of the French association Assedea and DysNet’s point of contact for EURORDIS. Deputy chair since the general assembly of 26 August 2026, carrying the registry mission.", "LR", "", "Mission 2 · Registry"),
...
<section>
  <div class="container">
    ...
    <ol class="demands">
      ...
      <li><details><summary><span class="demand-n">2</span><span>Research that looks for the causes of dysmelia, not only for how often it happens</span></summary>
        <div class="demand-body">
      ...
      <li><details><summary><span class="demand-n">3</span><span>Precaution first: science-based information and enforceable rules on products with suspected, potential or proven teratogenic effects</span></summary>
        <div class="demand-body">
      ...
      <li><details><summary><span class="demand-n">4</span><span>Universal coverage of prosthetics, research that reaches people with dysmelia, and an orphan medical devices framework that makes equipment affordable</span></summary>
        <div class="demand-body">
      ...
      <li><details><summary><span class="demand-n">5</span><span>Registries that cover whole populations, talk to each other, and hand people back their own data</span></summary>
        <div class="demand-body">
          ...
          <p>We ask for registries that cover whole populations, that are funded to last, that are independent of any single interest, and that talk to each other across countries. We ask that they adopt shared standards, so that aggregated data reach researchers without friction, and that any sharing of identifiable data rest on the explicit, revocable consent of the person or family concerned. Portability protects families too: a registry must be able to move its data if its host disappears or its funding ends.</p>
