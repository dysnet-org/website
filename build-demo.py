  ...
  <div class="container" style="--acc:var(--acc-library);--acc-text:var(--acc-library-text)">
    ...
    <div style="margin-top:var(--space-2)">
      ...
      <article class="entry">
        ...
        entries. Two findings are worth the detour. The survey run with the University of Leeds, <em>What if your baby has a limb
        ...
        <p class="src">Michi Moik, EDRIC · presented at Nijmegen, 13 October 2017 · published by Stichting NESOS ·
        <a href="https://softenon.nl/wp-content/uploads/2025/08/7_EDRIC.pdf" target="_blank" rel="noopener external">PDF, 25 slides, 1.6 MB</a> ·
